...
object SimulationService {
  ...
  def fromRow(simulation: Simulation, hsArgs: HSArgument): SimulationView = {
    SimulationView(simulation.id.get, simulation.temperature, hsArgs.a1, hsArgs.m1, hsArgs.m2, hsArgs.m3, hsArgs.m4, hsArgs.m5, hsArgs.m6, hsArgs.m7, hsArgs.m8, hsArgs.m9, hsArgs.epsSs)
  }
